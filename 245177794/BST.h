...
class BST {
  ...
  int GetHeight() const;
  void SplitBalance();
  int getHeight(TNode* curNode) const;
  void inOrderToArray(TNode* curNode, int sortedArray[], int& arrayIndex)const;
  void buildBalanceTree(int sortedArray[], int start, int end);
